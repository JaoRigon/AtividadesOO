    ...
    <fieldset>
        ...
        <label>
            ...
            <?php if ($tem_erros && isset($erros_validacao ['prazo'])) : ?>
                ...
                <?php endif; ?>
            <input type="text" name="prazo" value="<?php echo converte_data_para_tela($tarefa->getPrazo()); ?>" />
        </label>
        <fieldset>
        ...
        <input type="submit" class="btn primary" value="<?php echo ($tarefa->getId() > 0) ? 'Atualizar' : 'Cadastrar'; ?>" />
    </fieldset>
</form>